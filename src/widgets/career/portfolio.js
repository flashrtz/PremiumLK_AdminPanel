              ...
              <div className="row">
                <div className="col-sm-12">
                  <div className="tab">
                    {/* Nav tabs */}
                    <nav>
                      <div className="nav nav-tabs w-100 border-0" id="nav-tab" role="tablist"> <a className="nav-item nav-link active" id="nav-tab1" data-toggle="tab" href="#tab1-1" role="tab" aria-selected="true">Designer</a>
                        <a className="nav-item nav-link" id="nav-tab2" data-toggle="tab" href="#tab1-2" role="tab" aria-selected="false"> PHP Web Developer</a>
                        <a className="nav-item nav-link" id="nav-tab3" data-toggle="tab" href="#tab1-3" role="tab" aria-selected="false"> Marketing Manager</a>
                        <a className="nav-item nav-link" id="nav-tab4" data-toggle="tab" href="#tab1-4" role="tab" aria-selected="false"> Front-End Web Developer</a>
                      </div>
                    </nav>
                    <div className="tab-content px-5 pt-5" id="nav-tabContent">
                      <div role="tabpanel" className="tab-pane fade show active" id="tab1-1">
                        ...
                        <div className="d-flex align-items-center mb-3">
                          ...
                          <p className="mb-0 ml-3">It has survived not only five centuries, leap typesetting</p>
                        </div>
                        <div className="d-flex align-items-center mb-3">
                          <div className="badge-primary-soft rounded p-1">
                            <svg width={20} height={20} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="feather feather-check">
                        ...
                        <div className="d-flex align-items-center mb-3">
                          ...
                          <p className="mb-0 ml-3">The smartest thing to do with your Landing</p>
                        </div>
                        <div className="d-flex align-items-center">
                          ...
                          <p className="mb-0 ml-3">I will give you a complete account the teachings</p>
